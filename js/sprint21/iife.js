...
function ckyCount(callback) {
  ...
  request.onload = function () {
    if (this.status >= 200 && this.status < 400) {
      ...
      if (ckyActiveLaw) {
        ...
        switch (true) {
          case (ckyActiveLaw === 'gdpr' && showOnlyInEu && in_EU === false || ckyActiveLaw === 'ccpa' && showOnlyInCalifornia && country_name !== 'US' && region_code !== 'CA' || ckyActiveLaw === 'ccpa' && showOnlyInUs && country_name !== 'US'):
            disableBanner();
            break;
          default:
            displayBanner();
        ...
        var showOnlyInUs = cliConfig.options.geoTarget['ccpa'].us
        switch (true) {
          case (showOnlyInEu && !showOnlyInCalifornia && !showOnlyInUs && in_EU === true || !showOnlyInEu && showOnlyInCalifornia && !showOnlyInUs && country_name !== 'US' || showOnlyInEu && showOnlyInCalifornia && !showOnlyInUs && in_EU === true || !showOnlyInEu && !showOnlyInCalifornia && showOnlyInUs || showOnlyInEu && !showOnlyInCalifornia && showOnlyInUs && in_EU === true):
            activateGdpr();
            break;
          case (showOnlyInEu && !showOnlyInCalifornia && !showOnlyInUs && country_name === 'US' || !showOnlyInEu && showOnlyInCalifornia && !showOnlyInUs && region_code === 'CA' || showOnlyInEu && showOnlyInCalifornia && !showOnlyInUs && region_code === 'CA' || !showOnlyInEu && !showOnlyInCalifornia && showOnlyInUs && country_name === 'US' || showOnlyInEu && !showOnlyInCalifornia && showOnlyInUs && country_name === 'US') || (!showOnlyInEu && !showOnlyInCalifornia && !showOnlyInUs && region_code === 'CA'):
            activateCcpa();
            break;
  ...
  ckyLogCookies = function () {
    ...
    let log = [{
      ...
      "name": "Functional",
      "status": getCookie("cookieyes-functional")
    }, {
      "name": "Analytics",
      "status": getCookie("cookieyes-analytics")
    }, {
      "name": "Performance",
      "status": getCookie("cookieyes-performance")
    }, {
      "name": "Advertisement",
      "status": getCookie("cookieyes-advertisement")
    }, {
      "name": "Others",
      "status": getCookie("cookieyes-other")
    }];
    let consent_id = getCookie("cookieyesID");
    var request = new XMLHttpRequest();
    var data = new FormData();
    data.append('log', JSON.stringify(log));
    data.append('key', '3461c81c70c0a0495477f714');
...
function bannerActiveCheck() {
  ...
  if (!isActiveCheckCookiePresent && window.fetch && window.Promise) {
    fetch('https://active.cookieyes.com/api/3461c81c70c0a0495477f714/log', {
      method: 'POST'
    }).catch(function (err) {
      console.error(err);
    });
...
var tldomain = 'kiss.us';
var cliConfig = {
  "options": {
    "plan": "cookieyes tier 1",
    "theme": "custom",
    "colors": {
      "ccpa": {
        "notice": {
    ...
    "content": {
      "ccpa": {
        "text": {
          ...
          "el": "\u0391\u03c5\u03c4\u03cc\u03c2 \u03bf \u03b9\u03c3\u03c4\u03cc\u03c4\u03bf\u03c0\u03bf\u03c2 \u03ae \u03c4\u03b1 \u03b5\u03c1\u03b3\u03b1\u03bb\u03b5\u03af\u03b1 \u03c4\u03c1\u03af\u03c4\u03c9\u03bd \u03bc\u03b5\u03c1\u03ce\u03bd \u03b5\u03c0\u03b5\u03be\u03b5\u03c1\u03b3\u03ac\u03b6\u03bf\u03bd\u03c4\u03b1\u03b9 \u03c0\u03c1\u03bf\u03c3\u03c9\u03c0\u03b9\u03ba\u03ac \u03b4\u03b5\u03b4\u03bf\u03bc\u03ad\u03bd\u03b1. \u039c\u03c0\u03bf\u03c1\u03b5\u03af\u03c4\u03b5 \u03bd\u03b1 \u03b1\u03c1\u03bd\u03b7\u03b8\u03b5\u03af\u03c4\u03b5 \u03c4\u03b7\u03bd \u03c0\u03ce\u03bb\u03b7\u03c3\u03b7 \u03c4\u03c9\u03bd \u03c0\u03c1\u03bf\u03c3\u03c9\u03c0\u03b9\u03ba\u03ce\u03bd \u03c3\u03b1\u03c2 \u03c3\u03c4\u03bf\u03b9\u03c7\u03b5\u03af\u03c9\u03bd \u03ba\u03ac\u03bd\u03bf\u03bd\u03c4\u03b1\u03c2 \u03ba\u03bb\u03b9\u03ba \u03c3\u03c4\u03bf \u03c3\u03cd\u03bd\u03b4\u03b5\u03c3\u03bc\u03bf \"\u0394\u03b5\u03bd \u03b5\u03c0\u03b9\u03b8\u03c5\u03bc\u03ce \u03bd\u03b1 \u03c0\u03bf\u03c5\u03bb\u03ae\u03c3\u03c9 \u03c4\u03b1 \u03c0\u03c1\u03bf\u03c3\u03c9\u03c0\u03b9\u03ba\u03ac \u03bc\u03bf\u03c5 \u03c3\u03c4\u03bf\u03b9\u03c7\u03b5\u03af\u03b1\".",
          ...
          "et": "See veebisait v\u00f5i selle kolmanda osapoole t\u00f6\u00f6riistad t\u00f6\u00f6tlevad isikuandmeid. Isiklike andmete m\u00fc\u00fcgist saate loobuda, kui kl\u00f5psate lingil \"\u00c4rge m\u00fc\u00fcge minu isiklikke andmeid\".",
          ...
          "lv": "\u0160\u012b vietne vai t\u0101s tre\u0161o pu\u0161u r\u012bki apstr\u0101d\u0101 personas datus. J\u016bs varat atteikties no personisk\u0101s inform\u0101cijas p\u0101rdo\u0161anas, noklik\u0161\u0137inot uz saites \"Nep\u0101rdodiet manu personisko inform\u0101ciju\".",
          ...
          "pt-br": "Este site ou suas ferramentas de terceiros processam dados pessoais. Voc\u00ea pode optar por n\u00e3o vender suas informa\u00e7\u00f5es pessoais clicando no link \"N\u00e3o venda minhas informa\u00e7\u00f5es pessoais\"."
        },
        "title": {
          "ar": "\u064a\u0644\u0627\u062d\u0638",
          "bg": "\u0417\u0430\u0431\u0435\u043b\u0435\u0436\u0435\u0442\u0435",
        ...
        "buttons": {
          ...
          "doNotSell": {
            ...
            "el": "\u0394\u03b5\u03bd \u03b5\u03c0\u03b9\u03b8\u03c5\u03bc\u03ce \u03bd\u03b1 \u03c0\u03bf\u03c5\u03bb\u03ae\u03c3\u03c9 \u03c4\u03b1 \u03c0\u03c1\u03bf\u03c3\u03c9\u03c0\u03b9\u03ba\u03ac \u03bc\u03bf\u03c5 \u03c3\u03c4\u03bf\u03b9\u03c7\u03b5\u03af\u03b1",
            "en": "Do Not Sell My Personal Data",
            "es": "No venda mi informaci\u00f3n personal",
            "et": "\u00c4rge m\u00fc\u00fcge minu isiklikke andmeid",
            ...
            "lv": "Nep\u0101rdodiet manu personisko inform\u0101ciju",
        ...
        "confirmation": {
          "text": {
            ...
            "lv": "Vai tie\u0161\u0101m v\u0113laties atteikties?",
      ...
      "gdpr": {
        "text": {
          ...
          "el": "\u039f \u03c0\u03b1\u03c1\u03ce\u03bd \u03b9\u03c3\u03c4\u03cc\u03c4\u03bf\u03c0\u03bf\u03c2 \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03b5\u03af cookies \u03c0\u03bf\u03c5 \u03b2\u03bf\u03b7\u03b8\u03bf\u03cd\u03bd \u03c4\u03b7 \u03bb\u03b5\u03b9\u03c4\u03bf\u03c5\u03c1\u03b3\u03af\u03b1 \u03c4\u03bf\u03c5 \u03ba\u03b1\u03b9 \u03c0\u03b1\u03c1\u03b1\u03ba\u03bf\u03bb\u03bf\u03c5\u03b8\u03bf\u03cd\u03bd \u03c4\u03bf\u03bd \u03c4\u03c1\u03cc\u03c0\u03bf \u03bc\u03b5 \u03c4\u03bf\u03bd \u03bf\u03c0\u03bf\u03af\u03bf \u03b1\u03bb\u03bb\u03b7\u03bb\u03b5\u03c0\u03b9\u03b4\u03c1\u03ac\u03c4\u03b5 \u03bc\u03b5 \u03b1\u03c5\u03c4\u03cc\u03bd, \u03ce\u03c3\u03c4\u03b5 \u03bd\u03b1 \u03c3\u03b1\u03c2 \u03c0\u03b1\u03c1\u03ad\u03c7\u03bf\u03c5\u03bc\u03b5 \u03bc\u03b9\u03b1 \u03b2\u03b5\u03bb\u03c4\u03b9\u03c9\u03bc\u03ad\u03bd\u03b7 \u03ba\u03b1\u03b9 \u03c0\u03c1\u03bf\u03c3\u03b1\u03c1\u03bc\u03bf\u03c3\u03bc\u03ad\u03bd\u03b7 \u03b5\u03bc\u03c0\u03b5\u03b9\u03c1\u03af\u03b1 \u03c7\u03c1\u03ae\u03c3\u03c4\u03b7. \u0398\u03b1 \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03ae\u03c3\u03bf\u03c5\u03bc\u03b5 \u03c4\u03b1 cookies \u03bc\u03cc\u03bd\u03bf \u03b5\u03ac\u03bd \u03c3\u03c5\u03bd\u03b1\u03b9\u03bd\u03ad\u03c3\u03b5\u03c4\u03b5 \u03c3\u03c4\u03b7 \u03c7\u03c1\u03ae\u03c3\u03b7 \u03c4\u03bf\u03c5\u03c2 \u03ba\u03ac\u03bd\u03bf\u03bd\u03c4\u03b1\u03c2 \u03ba\u03bb\u03b9\u03ba \u03c3\u03c4\u03bf \u03ba\u03bf\u03c5\u03bc\u03c0\u03af \"\u0391\u03c0\u03bf\u03b4\u03bf\u03c7\u03ae \u03cc\u03bb\u03c9\u03bd\".",
          ...
          "et": "Teile parima kasutuskogemuse pakkumiseks kasutatakse lehek\u00fcljel k\u00fcpsiseid. K\u00fcpsised tagavad lehek\u00fclje toimimise, aitavad lehek\u00fclge paremaks muuta ning pakkuda teile asjakohast sisu ja reklaami. K\u00fcpsiseid kasutatakse ainult siis, kui annate selleks n\u00f5usoleku vajutades \u201eN\u00f5ustun\u201c.",
          ...
          "lv": "\u0160aj\u0101 vietn\u0113 tiek izmantoti s\u012bkfaili, kas pal\u012bdz t\u012bmek\u013ca vietnes funkcij\u0101m un izseko, k\u0101 j\u016bs mijiedarbojaties ar to, lai m\u0113s var\u0113tu nodro\u0161in\u0101t jums uzlabotu un piel\u0101gotu lieto\u0161anas pieredzi. M\u0113s izmantosim s\u012bkfailus tikai tad, ja j\u016bs tam piekrit\u012bsiet, noklik\u0161\u0137inot uz Pie\u0146emt.",
          ...
          "ro": "Acest site web folose\u0219te cookie-uri care ajut\u0103 la func\u021bionarea site-ului \u0219i urm\u0103re\u0219te modul \u00een care interac\u021biona\u021bi cu acesta, astfel \u00eenc\u00e2t s\u0103 v\u0103 putem oferi o experien\u021b\u0103 de utilizare \u00eembun\u0103t\u0103\u021bit\u0103 \u0219i personalizat\u0103. Vom folosi cookie-urile numai dac\u0103 sunte\u021bi de acord cu acestea f\u0103c\u00e2nd clic pe Accept.",
          ...
          "sv": "Denna webbplats anv\u00e4nder cookies som hj\u00e4lper webbplatsens funktioner och f\u00f6r att sp\u00e5ra hur du interagerar med den s\u00e5 att vi kan ge dig f\u00f6rb\u00e4ttrad och anpassad anv\u00e4ndarupplevelse. Vi anv\u00e4nder endast kakorna om du godk\u00e4nner det genom att klicka p\u00e5 Acceptera. Du kan ocks\u00e5 hantera individuella cookieinst\u00e4llningar fr\u00e5n Inst\u00e4llningar.",
          "th": "\u0e40\u0e27\u0e47\u0e1a\u0e44\u0e0b\u0e15\u0e4c\u0e19\u0e35\u0e49\u0e43\u0e0a\u0e49\u0e04\u0e38\u0e01\u0e01\u0e35\u0e49\u0e0a\u0e48\u0e27\u0e22\u0e01\u0e32\u0e23\u0e17\u0e33\u0e07\u0e32\u0e19\u0e02\u0e2d\u0e07\u0e40\u0e27\u0e47\u0e1a\u0e44\u0e0b\u0e15\u0e4c\u0e41\u0e25\u0e30\u0e15\u0e34\u0e14\u0e15\u0e32\u0e21\u0e27\u0e48\u0e32\u0e04\u0e38\u0e13\u0e42\u0e15\u0e49\u0e15\u0e2d\u0e1a\u0e01\u0e31\u0e1a\u0e21\u0e31\u0e19\u0e2d\u0e22\u0e48\u0e32\u0e07\u0e44\u0e23 \u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e43\u0e2b\u0e49\u0e40\u0e23\u0e32\u0e2a\u0e32\u0e21\u0e32\u0e23\u0e16\u0e21\u0e2d\u0e1a\u0e1b\u0e23\u0e30\u0e2a\u0e1a\u0e01\u0e32\u0e23\u0e13\u0e4c\u0e01\u0e32\u0e23\u0e43\u0e0a\u0e49\u0e07\u0e32\u0e19\u0e17\u0e35\u0e48\u0e14\u0e35\u0e02\u0e36\u0e49\u0e19\u0e41\u0e25\u0e30\u0e1b\u0e23\u0e31\u0e1a\u0e41\u0e15\u0e48\u0e07\u0e43\u0e2b\u0e49\u0e15\u0e23\u0e07\u0e43\u0e08\u0e04\u0e38\u0e13\u0e21\u0e32\u0e01\u0e02\u0e36\u0e49\u0e19 \u0e40\u0e23\u0e32\u0e08\u0e30\u0e43\u0e0a\u0e49\u0e04\u0e38\u0e01\u0e01\u0e35\u0e49\u0e01\u0e47\u0e15\u0e48\u0e2d\u0e40\u0e21\u0e37\u0e48\u0e2d\u0e04\u0e38\u0e13\u0e22\u0e34\u0e19\u0e22\u0e2d\u0e21\u0e42\u0e14\u0e22\u0e04\u0e25\u0e34\u0e01\u0e17\u0e35\u0e48\u0e22\u0e2d\u0e21\u0e23\u0e31\u0e1a",
          "tr": "Bu web sitesi, web sitesinin \u00e7al\u0131\u015fmas\u0131na yard\u0131mc\u0131 olan ve ayr\u0131ca web sitemizle nas\u0131l etkile\u015fim kurdu\u011funuzu takip eden tan\u0131mlama bilgileri kullan\u0131r. Ancak en iyi kullan\u0131c\u0131 deneyimini sa\u011flamam\u0131z i\u00e7in Ayarlar'dan belirli \u00e7erezleri etkinle\u015ftirin ve Kabul Et'e t\u0131klay\u0131n.",
          ...
          "pt-br": "Este site usa cookies que ajudam o site a funcionar e tamb\u00e9m para acompanhar como voc\u00ea interage com nosso site. Mas para fornecermos a melhor experi\u00eancia do usu\u00e1rio, habilitar os cookies espec\u00edficos das Configura\u00e7\u00f5es e clicar em Aceitar."
        },
        "title": {
    ...
    "categories": [
      {
        ...
        "description": {
          ...
          "pt-br": "<p>Os cookies necess\u00e1rios s\u00e3o cruciais para as fun\u00e7\u00f5es b\u00e1sicas do site e o site n\u00e3o funcionar\u00e1 como pretendido sem eles.<\/p> <p>Esses cookies n\u00e3o armazenam nenhum dado pessoalmente identific\u00e1vel.<\/p>",
          ...
          "lv": "<p>Nepiecie\u0161am\u0101s s\u012bkdatnes ir \u013coti svar\u012bgas t\u012bmek\u013ca vietnes pamatfunkcij\u0101m, un bez t\u0101m t\u012bmek\u013ca vietne nedarbosies paredz\u0113taj\u0101 veid\u0101.<\/p><p>\u0160\u012bs s\u012bkdatnes neuzkr\u0101j nek\u0101dus personiski identific\u0113jamus datus.<\/p>",
          "el": "<p>\u03a4\u03b1 \u03b1\u03c0\u03b1\u03c1\u03b1\u03af\u03c4\u03b7\u03c4\u03b1 cookies \u03b5\u03af\u03bd\u03b1\u03b9 \u03b6\u03c9\u03c4\u03b9\u03ba\u03ae\u03c2 \u03c3\u03b7\u03bc\u03b1\u03c3\u03af\u03b1\u03c2 \u03b3\u03b9\u03b1 \u03c4\u03b9\u03c2 \u03b2\u03b1\u03c3\u03b9\u03ba\u03ad\u03c2 \u03bb\u03b5\u03b9\u03c4\u03bf\u03c5\u03c1\u03b3\u03af\u03b5\u03c2 \u03c4\u03bf\u03c5 \u03b9\u03c3\u03c4\u03cc\u03c4\u03bf\u03c0\u03bf\u03c5, \u03bf \u03bf\u03c0\u03bf\u03af\u03bf\u03c2 \u03b4\u03b5\u03bd \u03b8\u03b1 \u03bb\u03b5\u03b9\u03c4\u03bf\u03c5\u03c1\u03b3\u03b5\u03af \u03bc\u03b5 \u03c4\u03bf\u03bd \u03c0\u03c1\u03bf\u03b2\u03bb\u03b5\u03c0\u03cc\u03bc\u03b5\u03bd\u03bf \u03c4\u03c1\u03cc\u03c0\u03bf \u03c7\u03c9\u03c1\u03af\u03c2 \u03b1\u03c5\u03c4\u03ac.<\/p><p>\u03a4\u03b1 cookies \u03b1\u03c5\u03c4\u03ac \u03b4\u03b5\u03bd \u03b1\u03c0\u03bf\u03b8\u03b7\u03ba\u03b5\u03cd\u03bf\u03c5\u03bd \u03b4\u03b5\u03b4\u03bf\u03bc\u03ad\u03bd\u03b1 \u03c0\u03c1\u03bf\u03c3\u03c9\u03c0\u03b9\u03ba\u03ae\u03c2 \u03c4\u03b1\u03c5\u03c4\u03bf\u03c0\u03bf\u03af\u03b7\u03c3\u03b7\u03c2.<\/p>"
        },
        "slug": "necessary",
        "type": 1,
        "status": 1,
        ...
        "created_at": "2021-06-22 20:52:20",
        "updated_at": "2021-06-22 21:14:50",
        "cookies": [{
          "id": 544961,
          ...
          "created_at": "2021-06-22 21:19:56",
          "updated_at": "2021-06-22 21:19:56",
          ...
          "cookie_id": "__cfruid",
          "description": {
            "en": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "de": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "fr": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "it": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "es": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "nl": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "bg": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "da": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "ru": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "ar": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "pl": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "pt": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "ca": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "hu": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "sv": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "cr": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "zh": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "uk": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "sk": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "tr": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "lt": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "cs": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "fi": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "no": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "pt-br": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "sl": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "ro": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "th": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "et": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "lv": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic.",
            "el": "This cookie is set by the provider Cloudflare. This cookie is used for load balancing and for identifying trusted web traffic."
          },
          "type": 1,
          "category_id": 284709,
          "duration": "session",
          "domain": ".kissbooks.zendesk.com",
          "website_id": 53323,
          "script_slug": "cloudflare_service",
          "url_pattern": "cloudflare.com",
          "created_from_scan": 1,
          "url_pattern_updated": 0,
          "created_at": "2021-06-22 21:19:56",
          "updated_at": "2021-06-22 21:19:56",
          ...
          "id": 544971,
          "cookie_id": "AWSALBCORS",
          "description": {
            "en": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "de": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "fr": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "it": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "es": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "nl": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "bg": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "da": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "ru": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "ar": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "pl": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "pt": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "ca": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "hu": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "sv": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "cr": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "zh": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "uk": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "sk": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "tr": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "lt": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "cs": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "fi": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "no": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "pt-br": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "sl": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "ro": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "th": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "et": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "lv": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness.",
            "el": "This cookie is used for load balancing services provded by Amazon inorder to optimize the user experience. Amazon has updated the ALB and CLB so that customers can continue to use the CORS request with stickness."
          },
          "type": 1,
          "category_id": 284709,
          "duration": "7 days",
        ...
        "description": {
          ...
          "lv": "<p>Funkcion\u0101lie s\u012bkfaili pal\u012bdz veikt noteiktas funkcijas, piem\u0113ram, kop\u012bgot vietnes saturu soci\u0101lo mediju platform\u0101s, v\u0101kt atsauksmes un citas tre\u0161o personu funkcijas.<\/p>",
          "el": "<p>\u03a4\u03b1 \u03bb\u03b5\u03b9\u03c4\u03bf\u03c5\u03c1\u03b3\u03b9\u03ba\u03ac cookies \u03b2\u03bf\u03b7\u03b8\u03bf\u03cd\u03bd \u03c3\u03c4\u03b7\u03bd \u03b5\u03ba\u03c4\u03ad\u03bb\u03b5\u03c3\u03b7 \u03bf\u03c1\u03b9\u03c3\u03bc\u03ad\u03bd\u03c9\u03bd \u03bb\u03b5\u03b9\u03c4\u03bf\u03c5\u03c1\u03b3\u03b9\u03ce\u03bd, \u03cc\u03c0\u03c9\u03c2 \u03b7 \u03ba\u03bf\u03b9\u03bd\u03ae \u03c7\u03c1\u03ae\u03c3\u03b7 \u03c4\u03bf\u03c5 \u03c0\u03b5\u03c1\u03b9\u03b5\u03c7\u03bf\u03bc\u03ad\u03bd\u03bf\u03c5 \u03c4\u03bf\u03c5 \u03b9\u03c3\u03c4\u03cc\u03c4\u03bf\u03c0\u03bf\u03c5 \u03c3\u03b5 \u03c0\u03bb\u03b1\u03c4\u03c6\u03cc\u03c1\u03bc\u03b5\u03c2 \u03ba\u03bf\u03b9\u03bd\u03c9\u03bd\u03b9\u03ba\u03ce\u03bd \u03bc\u03ad\u03c3\u03c9\u03bd, \u03b7 \u03c3\u03c5\u03bb\u03bb\u03bf\u03b3\u03ae \u03c3\u03c7\u03bf\u03bb\u03af\u03c9\u03bd \u03ba\u03b1\u03b9 \u03ac\u03bb\u03bb\u03b5\u03c2 \u03bb\u03b5\u03b9\u03c4\u03bf\u03c5\u03c1\u03b3\u03af\u03b5\u03c2 \u03c4\u03c1\u03af\u03c4\u03c9\u03bd.<\/p>"
        },
        "slug": "functional",
        "type": 2,
        "status": 0,
        ...
        "cookies": [{
          ...
          "description": {
            ...
            "de": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "fr": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "it": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "es": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "nl": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "bg": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "da": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "ru": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "ar": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "pl": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "pt": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "ca": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "hu": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "sv": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "cr": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "zh": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "uk": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "sk": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "tr": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "lt": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "cs": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "fi": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "no": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "pt-br": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "sl": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "ro": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "th": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "et": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "lv": "This cookie is used by Zendesk live chat and is used to store the live chat ID.",
            "el": "This cookie is used by Zendesk live chat and is used to store the live chat ID."
          },
          "type": 1,
          "category_id": 284710,
          "duration": "1 year",
        ...
        "description": {
          ...
          "pt-br": "<p>Cookies anal\u00edticos s\u00e3o usados para entender como os visitantes interagem com o site. Esses cookies ajudam a fornecer informa\u00e7\u00f5es sobre m\u00e9tricas o n\u00famero de visitantes, taxa de rejei\u00e7\u00e3o, fonte de tr\u00e1fego, etc.<\/p>",
          ...
          "et": "<p>Anal\u00fc\u00fctilisi k\u00fcpsiseid kasutatakse selleks, et m\u00f5ista, kuidas k\u00fclastajad veebilehega suhtlevad. Need k\u00fcpsised aitavad anda teavet k\u00fclastajate arvu, liikluse allika, jms kohta.<\/p>",
          "lv": "<p>Anal\u012btisk\u0101s s\u012bkdatnes tiek izmantotas, lai saprastu, k\u0101 apmekl\u0113t\u0101ji mijiedarbojas ar t\u012bmek\u013ca vietni. \u0160\u012bs s\u012bkdatnes pal\u012bdz ieg\u016bt inform\u0101ciju par apmekl\u0113t\u0101ju skaitu, atteikumu \u012bpatsvaru, datpl\u016bsmas avotiem u. c.<\/p>",
          "el": "<p>\u03a4\u03b1 \u03b1\u03bd\u03b1\u03bb\u03c5\u03c4\u03b9\u03ba\u03ac cookies \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03bf\u03cd\u03bd\u03c4\u03b1\u03b9 \u03b3\u03b9\u03b1 \u03bd\u03b1 \u03ba\u03b1\u03c4\u03b1\u03bd\u03bf\u03ae\u03c3\u03bf\u03c5\u03bc\u03b5 \u03c0\u03ce\u03c2 \u03b1\u03bb\u03bb\u03b7\u03bb\u03b5\u03c0\u03b9\u03b4\u03c1\u03bf\u03cd\u03bd \u03bf\u03b9 \u03b5\u03c0\u03b9\u03c3\u03ba\u03ad\u03c0\u03c4\u03b5\u03c2 \u03bc\u03b5 \u03c4\u03bf\u03bd \u03b9\u03c3\u03c4\u03cc\u03c4\u03bf\u03c0\u03bf. \u0391\u03c5\u03c4\u03ac \u03c4\u03b1 cookies \u03c0\u03b1\u03c1\u03ad\u03c7\u03bf\u03c5\u03bd \u03c0\u03bb\u03b7\u03c1\u03bf\u03c6\u03bf\u03c1\u03af\u03b5\u03c2 \u03c3\u03c7\u03b5\u03c4\u03b9\u03ba\u03ac \u03bc\u03b5 \u03bc\u03b5\u03c4\u03c1\u03ae\u03c3\u03b5\u03b9\u03c2, \u03cc\u03c0\u03c9\u03c2 \u03bf \u03b1\u03c1\u03b9\u03b8\u03bc\u03cc\u03c2 \u03c4\u03c9\u03bd \u03b5\u03c0\u03b9\u03c3\u03ba\u03b5\u03c0\u03c4\u03ce\u03bd, \u03c4\u03bf \u03c0\u03bf\u03c3\u03bf\u03c3\u03c4\u03cc \u03b5\u03b3\u03ba\u03b1\u03c4\u03ac\u03bb\u03b5\u03b9\u03c8\u03b7\u03c2, \u03b7 \u03c0\u03b7\u03b3\u03ae \u03b5\u03c0\u03b9\u03c3\u03ba\u03b5\u03c8\u03b9\u03bc\u03cc\u03c4\u03b7\u03c4\u03b1\u03c2 \u03ba.\u03bb\u03c0.<\/p>"
        },
        "slug": "analytics",
        "type": 2,
        "status": 0,
        ...
        "cookies": [{
          ...
          "description": {
            ...
            "pt-br": "This cookie is installed by Google Analytics. The cookie is used to calculate visitor, session, campaign data and keep track of site usage for the site's analytics report. The cookies store information anonymously and assign a randomly generated number to identify unique visitors.",
            ...
            "et": "This cookie is installed by Google Analytics. The cookie is used to calculate visitor, session, campaign data and keep track of site usage for the site's analytics report. The cookies store information anonymously and assign a randomly generated number to identify unique visitors.",
            "lv": "This cookie is installed by Google Analytics. The cookie is used to calculate visitor, session, campaign data and keep track of site usage for the site's analytics report. The cookies store information anonymously and assign a randomly generated number to identify unique visitors.",
            "el": "This cookie is installed by Google Analytics. The cookie is used to calculate visitor, session, campaign data and keep track of site usage for the site's analytics report. The cookies store information anonymously and assign a randomly generated number to identify unique visitors."
          },
          "type": 1,
          "category_id": 284711,
          "duration": "2 years",
          ...
          "description": {
            ...
            "pt-br": "This cookie is installed by Google Analytics. The cookie is used to store information of how visitors use a website and helps in creating an analytics report of how the website is doing. The data collected including the number visitors, the source where they have come from, and the pages visted in an anonymous form.",
            ...
            "et": "This cookie is installed by Google Analytics. The cookie is used to store information of how visitors use a website and helps in creating an analytics report of how the website is doing. The data collected including the number visitors, the source where they have come from, and the pages visted in an anonymous form.",
            "lv": "This cookie is installed by Google Analytics. The cookie is used to store information of how visitors use a website and helps in creating an analytics report of how the website is doing. The data collected including the number visitors, the source where they have come from, and the pages visted in an anonymous form.",
            "el": "This cookie is installed by Google Analytics. The cookie is used to store information of how visitors use a website and helps in creating an analytics report of how the website is doing. The data collected including the number visitors, the source where they have come from, and the pages visted in an anonymous form."
          },
          "type": 1,
          "category_id": 284711,
          "duration": "1 day",
          ...
          "id": 544982,
          "cookie_id": "_gat_gtag_UA_9081461_2",
          "description": {
          ...
          "description": {
            ...
            "pt-br": "This cookie is set by Hotjar. This cookie is set when the customer first lands on a page with the Hotjar script. It is used to persist the random user ID, unique to that site on the browser. This ensures that behavior in subsequent visits to the same site will be attributed to the same user ID.",
            ...
            "et": "This cookie is set by Hotjar. This cookie is set when the customer first lands on a page with the Hotjar script. It is used to persist the random user ID, unique to that site on the browser. This ensures that behavior in subsequent visits to the same site will be attributed to the same user ID.",
            "lv": "This cookie is set by Hotjar. This cookie is set when the customer first lands on a page with the Hotjar script. It is used to persist the random user ID, unique to that site on the browser. This ensures that behavior in subsequent visits to the same site will be attributed to the same user ID.",
            "el": "This cookie is set by Hotjar. This cookie is set when the customer first lands on a page with the Hotjar script. It is used to persist the random user ID, unique to that site on the browser. This ensures that behavior in subsequent visits to the same site will be attributed to the same user ID."
          },
          "type": 1,
          "category_id": 284711,
          "duration": "1 year",
          ...
          "description": {
            ...
            "pt-br": "This is set by Hotjar to identify a new user\u2019s first session. It stores a true\/false value, indicating whether this was the first time Hotjar saw this user. It is used by Recording filters to identify new user sessions.",
            ...
            "et": "This is set by Hotjar to identify a new user\u2019s first session. It stores a true\/false value, indicating whether this was the first time Hotjar saw this user. It is used by Recording filters to identify new user sessions.",
            "lv": "This is set by Hotjar to identify a new user\u2019s first session. It stores a true\/false value, indicating whether this was the first time Hotjar saw this user. It is used by Recording filters to identify new user sessions.",
            "el": "This is set by Hotjar to identify a new user\u2019s first session. It stores a true\/false value, indicating whether this was the first time Hotjar saw this user. It is used by Recording filters to identify new user sessions."
          },
          "type": 1,
          "category_id": 284711,
          "duration": "30 minutes",
        ...
        "description": {
          ...
          "pt-br": "<p>Os cookies de desempenho s\u00e3o usados para entender e analisar os principais \u00edndices de desempenho do site, o que ajuda a oferecer uma melhor experi\u00eancia do usu\u00e1rio para os visitantes.<\/p>",
          ...
          "lv": "<p>Veiktsp\u0113jas s\u012bkfaili tiek izmantoti, lai izprastu un analiz\u0113tu vietnes galvenos veiktsp\u0113jas r\u0101d\u012bt\u0101jus, kas pal\u012bdz apmekl\u0113t\u0101jiem nodro\u0161in\u0101t lab\u0101ku lieto\u0161anas pieredzi.<\/p>",
          "el": "<p>\u03a4\u03b1 cookies \u03b1\u03c0\u03cc\u03b4\u03bf\u03c3\u03b7\u03c2 \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03bf\u03cd\u03bd\u03c4\u03b1\u03b9 \u03b3\u03b9\u03b1 \u03c4\u03b7\u03bd \u03ba\u03b1\u03c4\u03b1\u03bd\u03cc\u03b7\u03c3\u03b7 \u03ba\u03b1\u03b9 \u03c4\u03b7\u03bd \u03b1\u03bd\u03ac\u03bb\u03c5\u03c3\u03b7 \u03c4\u03c9\u03bd \u03b2\u03b1\u03c3\u03b9\u03ba\u03ce\u03bd \u03b4\u03b5\u03b9\u03ba\u03c4\u03ce\u03bd \u03b1\u03c0\u03cc\u03b4\u03bf\u03c3\u03b7\u03c2 \u03c4\u03bf\u03c5 \u03b9\u03c3\u03c4\u03cc\u03c4\u03bf\u03c0\u03bf\u03c5, \u03bf\u03b9 \u03bf\u03c0\u03bf\u03af\u03bf\u03b9 \u03b2\u03bf\u03b7\u03b8\u03bf\u03cd\u03bd \u03c3\u03c4\u03b7\u03bd \u03c0\u03b1\u03c1\u03bf\u03c7\u03ae \u03bc\u03b9\u03b1\u03c2 \u03ba\u03b1\u03bb\u03cd\u03c4\u03b5\u03c1\u03b7\u03c2 \u03b5\u03bc\u03c0\u03b5\u03b9\u03c1\u03af\u03b1\u03c2 \u03c7\u03c1\u03ae\u03c3\u03c4\u03b7 \u03b3\u03b9\u03b1 \u03c4\u03bf\u03c5\u03c2 \u03b5\u03c0\u03b9\u03c3\u03ba\u03ad\u03c0\u03c4\u03b5\u03c2.<\/p>"
        },
        "slug": "performance",
        "type": 2,
        "status": 0,
        ...
        "cookies": [{
          ...
          "description": {
            ...
            "et": "This cookies is installed by Google Universal Analytics to throttle the request rate to limit the colllection of data on high traffic sites.",
            "lv": "This cookies is installed by Google Universal Analytics to throttle the request rate to limit the colllection of data on high traffic sites.",
            "el": "This cookies is installed by Google Universal Analytics to throttle the request rate to limit the colllection of data on high traffic sites."
          },
          "type": 1,
          "category_id": 284712,
          "duration": "1 minute",
        ...
        "description": {
          ...
          "pt-br": "<p>Os cookies de an\u00fancios s\u00e3o usados para entregar aos visitantes an\u00fancios personalizados com base nas p\u00e1ginas que visitaram antes e analisar a efic\u00e1cia da campanha publicit\u00e1ria.<\/p>",
          ...
          "et": "<p>Turundusega seotud k\u00fcpsiseid kasutatakse selleks, et edastada k\u00fclastajatele kohandatud reklaami vastavalt nende poolt eelnevalt k\u00fclastatud lehek\u00fclgedele ja anal\u00fc\u00fcsida reklaamikampaania t\u00f5husust.<\/p>",
          "lv": "<p>Rekl\u0101mu s\u012bkfaili tiek izmantoti, lai nodro\u0161in\u0101tu apmekl\u0113t\u0101jiem piel\u0101gotas rekl\u0101mas, pamatojoties uz iepriek\u0161 apmekl\u0113taj\u0101m lap\u0101m, un analiz\u0113tu rekl\u0101mas kampa\u0146as efektivit\u0101ti.<\/p>",
          "el": "<p>\u03a4\u03b1 cookies \u03b4\u03b9\u03b1\u03c6\u03ae\u03bc\u03b9\u03c3\u03b7\u03c2 \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03bf\u03cd\u03bd\u03c4\u03b1\u03b9 \u03b3\u03b9\u03b1 \u03bd\u03b1 \u03b4\u03ce\u03c3\u03bf\u03c5\u03bd \u03c3\u03c4\u03bf\u03c5\u03c2 \u03b5\u03c0\u03b9\u03c3\u03ba\u03ad\u03c0\u03c4\u03b5\u03c2 \u03c0\u03c1\u03bf\u03c3\u03b1\u03c1\u03bc\u03bf\u03c3\u03bc\u03ad\u03bd\u03b5\u03c2 \u03b4\u03b9\u03b1\u03c6\u03b7\u03bc\u03af\u03c3\u03b5\u03b9\u03c2 \u03b2\u03ac\u03c3\u03b5\u03b9 \u03c4\u03c9\u03bd \u03c3\u03b5\u03bb\u03af\u03b4\u03c9\u03bd \u03c0\u03bf\u03c5 \u03ad\u03c7\u03bf\u03c5\u03bd \u03b5\u03c0\u03b9\u03c3\u03ba\u03b5\u03c6\u03c4\u03b5\u03af \u03ba\u03b1\u03b9 \u03bd\u03b1 \u03b1\u03bd\u03b1\u03bb\u03cd\u03c3\u03bf\u03c5\u03bd \u03c4\u03b7\u03bd \u03b1\u03c0\u03bf\u03c4\u03b5\u03bb\u03b5\u03c3\u03bc\u03b1\u03c4\u03b9\u03ba\u03cc\u03c4\u03b7\u03c4\u03b1 \u03c4\u03b7\u03c2 \u03b4\u03b9\u03b1\u03c6\u03b7\u03bc\u03b9\u03c3\u03c4\u03b9\u03ba\u03ae\u03c2 \u03ba\u03b1\u03bc\u03c0\u03ac\u03bd\u03b9\u03b1\u03c2.<\/p>"
        },
        "slug": "advertisement",
        "type": 2,
        "status": 0,
        ...
        "cookies": [{
          ...
          "description": {
            ...
            "sv": "This cookie is set by Facebook to deliver advertisement when they are on Facebook or a digital platform powered by Facebook advertising after visiting this website.",
            ...
            "ro": "This cookie is set by Facebook to deliver advertisement when they are on Facebook or a digital platform powered by Facebook advertising after visiting this website.",
            "th": "This cookie is set by Facebook to deliver advertisement when they are on Facebook or a digital platform powered by Facebook advertising after visiting this website.",
            "et": "This cookie is set by Facebook to deliver advertisement when they are on Facebook or a digital platform powered by Facebook advertising after visiting this website.",
            "lv": "This cookie is set by Facebook to deliver advertisement when they are on Facebook or a digital platform powered by Facebook advertising after visiting this website.",
            "el": "This cookie is set by Facebook to deliver advertisement when they are on Facebook or a digital platform powered by Facebook advertising after visiting this website."
          },
          "type": 1,
          "category_id": 284713,
          "duration": "3 months",
          ...
          "cookie_id": "uid",
          "description": {
            "en": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "de": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "fr": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "it": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "es": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "nl": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "bg": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "da": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "ru": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "ar": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "pl": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "pt": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "ca": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "hu": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "sv": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "cr": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "zh": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "uk": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "sk": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "tr": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "lt": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "cs": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "fi": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "no": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "pt-br": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "sl": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "ro": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "th": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "et": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "lv": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments.",
            "el": "This cookie is used to measure the number and behavior of the visitors to the website anonymously. The data includes the number of visits, average duration of the visit on the website, pages visited, etc. for the purpose of better understanding user preferences for targeted advertisments."
          },
          "type": 1,
          "category_id": 284713,
          "duration": "",
          ...
          "cookie_id": "fr",
          "description": {
            "en": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "de": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            ...
            "it": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "es": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "nl": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "bg": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "da": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "ru": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "ar": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "pl": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "pt": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "ca": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "hu": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "sv": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "cr": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "zh": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "uk": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "sk": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "tr": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "lt": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "cs": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "fi": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "no": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "pt-br": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "sl": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "ro": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "th": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "et": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "lv": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin.",
            "el": "The cookie is set by Facebook to show relevant advertisments to the users and measure and improve the advertisements. The cookie also tracks the behavior of the user across the web on sites that have Facebook pixel or Facebook social plugin."
          },
          "type": 1,
          "category_id": 284713,
          "duration": "3 months",
          ...
          "cookie_id": "ATN",
          "description": {
            "en": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "de": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "fr": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "it": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "es": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "nl": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "bg": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "da": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "ru": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "ar": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "pl": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "pt": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "ca": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "hu": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "sv": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "cr": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "zh": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "uk": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "sk": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "tr": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "lt": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "cs": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "fi": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "no": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "pt-br": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "sl": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "ro": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "th": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "et": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "lv": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website.",
            "el": "The cookie is set by atdmt.com. The cookies stores data about the user behavior on multiple websites. The data is then used to serve relevant advertisements to the users on the website."
          },
          "type": 1,
          "category_id": 284713,
          "duration": "2 years",
          "domain": ".atdmt.com",
          "website_id": 53323,
          "script_slug": "atlas_solutions",
          "url_pattern": "atdmt.com",
          "created_from_scan": 1,
          "url_pattern_updated": 0,
          "created_at": "2021-06-22 21:19:56",
          "updated_at": "2021-06-22 21:19:56",
          ...
          "description": {
            ...
            "pt-br": "Used by Google DoubleClick and stores information about how the user uses the website and any other advertisement before visiting the website. This is used to present users with ads that are relevant to them according to the user profile.",
            ...
            "et": "Used by Google DoubleClick and stores information about how the user uses the website and any other advertisement before visiting the website. This is used to present users with ads that are relevant to them according to the user profile.",
            "lv": "Used by Google DoubleClick and stores information about how the user uses the website and any other advertisement before visiting the website. This is used to present users with ads that are relevant to them according to the user profile.",
            "el": "Used by Google DoubleClick and stores information about how the user uses the website and any other advertisement before visiting the website. This is used to present users with ads that are relevant to them according to the user profile."
          },
          "type": 1,
          "category_id": 284713,
        ...
        "description": {
          ...
          "el": "<p>\u0386\u03bb\u03bb\u03b1 \u03bc\u03b7 \u03ba\u03b1\u03c4\u03b7\u03b3\u03bf\u03c1\u03b9\u03bf\u03c0\u03bf\u03b9\u03b7\u03bc\u03ad\u03bd\u03b1 cookies \u03b5\u03af\u03bd\u03b1\u03b9 \u03b1\u03c5\u03c4\u03ac \u03c0\u03bf\u03c5 \u03b1\u03bd\u03b1\u03bb\u03cd\u03bf\u03bd\u03c4\u03b1\u03b9 \u03ba\u03b1\u03b9 \u03b4\u03b5\u03bd \u03ad\u03c7\u03bf\u03c5\u03bd \u03b1\u03ba\u03cc\u03bc\u03b7 \u03c4\u03b1\u03be\u03b9\u03bd\u03bf\u03bc\u03b7\u03b8\u03b5\u03af \u03c3\u03b5 \u03ba\u03b1\u03c4\u03b7\u03b3\u03bf\u03c1\u03af\u03b1.<\/p>"
        },
        "slug": "other",
        "type": 2,
        "status": 0,
        ...
        "cookies": [{
          ...
          "id": 544955,
          "cookie_id": "_upscope__everConnected",
          "description": {
            "en": "No description",
            "de": "No description",
            "fr": "No description",
          ...
          "id": 544957,
          "cookie_id": "et_pb_ab_view_page_167",
          "description": {
            "en": "No description",
            "de": "No description",
            "fr": "No description",
          ...
          "type": 0,
          "category_id": 284737,
          "duration": "16 years 6 months 9 days 3 hours",
          "domain": ".youtube.com",
          "website_id": 53323,
          "script_slug": null,
          "url_pattern": null,
...
var cookieyesID = btoa(randomString(32));
//btoa(+new Date);
...
window.addEventListener('load', function () {
  ...
  var createBannerOnLoad = function createBannerOnLoad(ckyActiveLaw) {
    ...
    function renderStickyDetail() {
      ...
      var ckyDetailWrapper = '<div class="cky-detail-wrapper" id="cky-detail-wrapper" style="border-color:' + colors[ckyActiveLaw].notice.borderColor + '">\
                                          <div class="cky-tab">\
      ...
      for (var i = 0; i < categories.length + 1; i++) {
        if (i === 0) {
          ...
          var ckyTabContentItem = '<div class="cky-tab-content-item cky-tab-content-active" id="cky-tab-content-privacy">\
                                                  ...
                                                  <div class="cky-tab-desc" style="color:' + colors[ckyActiveLaw].notice.textColor + '">' + privacyPolicy.text[selectedLanguage] + '</div>\
                                              </div>';
          ...
          var ckyTabContentItem = '<div class="cky-tab-content-item" id="cky-tab-content-' + category.name[selectedLanguage] + '">\
                                                  <div class="cky-tab-title" id="cky-tab-title-' + category.name[selectedLanguage] + '" style="color:' + colors[ckyActiveLaw].notice.textColor + '">' + category.name[selectedLanguage] + '</div>\
                                                  <div class="cky-tab-desc" style="color:' + colors[ckyActiveLaw].notice.textColor + '">' + category.description[selectedLanguage] + '</div>\
                                              </div>';
          document.querySelector("#cky-consent #cky-tab-content").insertAdjacentHTML("beforeend", ckyTabContentItem);
          if (!options.showCategoryDirectly) {
            createSwitches(category);
      ...
      var customAcceptButton = '<button class="cky-btn cky-btn-custom-accept"\
          style = "\
                      ...
                      "\
          id="cky-btn-custom-accept">' + content[ckyActiveLaw].customAcceptButton[selectedLanguage] + '</button>';
      if (options.showCategoryDirectly) {
    ...
    function renderPopupDetail() {
      ...
      for (var i = 0; i < categories.length + 1; i++) {
        if (i === 0) {
          ...
          var ckyTabContentItem = '<div class="cky-tab-content-item" id="cky-tab-content-' + category.name[selectedLanguage] + '">\
                                                  <div class="cky-tab-title" id="cky-tab-title-' + category.name[selectedLanguage] + '" style="color:' + colors[ckyActiveLaw].notice.textColor + '">' + category.name[selectedLanguage] + '</div>\
                                                  <div class="cky-tab-desc" style="color:' + colors[ckyActiveLaw].notice.textColor + '">' + category.description[selectedLanguage] + '</>\
                                              </div>';
          document.querySelector("#cky-settings-popup #cky-tab-menu").insertAdjacentHTML("beforeend", ckyTabItem);
          document.querySelector("#cky-settings-popup #cky-tab-content").insertAdjacentHTML("beforeend", ckyTabContentItem);
          if (!options.showCategoryDirectly) {
    ...
    function showToggler() {
      ...
      if (JSON.parse(display[ckyActiveLaw].noticeToggler)) {
        var cliConsentBarTrigger = '<div class="cky-consent-bar-trigger" id="cky-consent-toggler" onclick="revisitCkyConsent()" style="\
                  ...
                  ">' + content[ckyActiveLaw].noticeToggler[selectedLanguage] + '</div>';
      ...
      if (typeof category.cookies !== "undefined") {
        ...
        var auditTable = '\
                  <div class="cky-table-wrapper">\
                      <table id="' + auditTableId + category.id + '" class="cky-cookie-audit-table">\
                          <thead>\
                              <tr>\
                                  <th>' + content[ckyActiveLaw].auditTable.cookie[selectedLanguage] + "</th>\
                                  <th>" + content[ckyActiveLaw].auditTable.type[selectedLanguage] + "</th>\
                                  <th>" + content[ckyActiveLaw].auditTable.duration[selectedLanguage] + "</th>\
                                  <th>" + content[ckyActiveLaw].auditTable.description[selectedLanguage] + "</th>\
                              </tr>\
                          </thead>\
                          <tbody>\
                          </tbody>\
...
if (navigator.doNotTrack == 1) {
  ...
  categoryScripts.forEach(function (item) {
    if (item.categories.length === 1 && item.categories[0] && loadAnalyticsByDefault)
      return;
    if (ckyconsent !== "yes") {
      CKY_BLACKLIST.push(new RegExp(escapeRegExp(item.re)));
      return
