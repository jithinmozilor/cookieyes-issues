...
function ckyCount(callback) {
  ...
  ckyLogCookies = function () {
    ...
    data.append("key", "cb20e09d943853223d560687");
...
function bannerActiveCheck() {
  ...
  if (!isActiveCheckCookiePresent && window.fetch && window.Promise) {
    fetch("https://active.cookieyes.com/api/cb20e09d943853223d560687/log", {
      method: "POST",
    }).catch(function (err) {
      console.error(err);
    });
...
var tldomain = "marqueeincentives.com";
var cliConfig = {
  options: {
    plan: "cookieyes tier 2",
    theme: "light",
    colors: {
      ccpa: {
        notice: {
    ...
    tldomain: "marqueeincentives.com",
    behaviour: {
      reload: false,
      showLogo: true,
    ...
    customCss: null,
    geoTarget: { ccpa: { us: false, california: true }, gdpr: { eu: true } },
    ...
    categories: [
      {
        ...
        created_at: "2021-06-18 18:00:42",
        updated_at: "2021-06-19 13:50:15",
        cookies: [
          {
            id: 532595,
            cookie_id: "PHPSESSID",
            description: {
              en: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              de: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              fr: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              it: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              es: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              nl: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              bg: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              da: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              ru: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              ar: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              pl: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              pt: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              ca: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              hu: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              sv: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              cr: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              zh: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              uk: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              sk: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              tr: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              lt: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              cs: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              fi: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              no: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              "pt-br":
                "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              sl: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              ro: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              th: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              et: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              lv: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
              el: "This cookie is native to PHP applications. The cookie is used to store and identify a users' unique session ID for the purpose of managing user session on the website. The cookie is a session cookies and is deleted when all the browser windows are closed.",
            },
            type: 1,
            category_id: 279760,
            duration: "session",
            domain: "marqueeincentives.com",
            website_id: 52465,
            script_slug: null,
            url_pattern: null,
            created_from_scan: 1,
            url_pattern_updated: 0,
            created_at: "2021-06-18 19:08:38",
            updated_at: "2021-06-18 19:08:38",
          ...
          },
          {
            ...
            description: {
              en: "This cookie stores the user's consent state for the current domain.",
              de: "This cookie stores the user's consent state for the current domain.",
              fr: "This cookie stores the user's consent state for the current domain.",
              it: "This cookie stores the user's consent state for the current domain.",
              es: "This cookie stores the user's consent state for the current domain.",
              nl: "This cookie stores the user's consent state for the current domain.",
              bg: "This cookie stores the user's consent state for the current domain.",
              da: "This cookie stores the user's consent state for the current domain.",
              ru: "This cookie stores the user's consent state for the current domain.",
              ar: "This cookie stores the user's consent state for the current domain.",
              pl: "This cookie stores the user's consent state for the current domain.",
              pt: "This cookie stores the user's consent state for the current domain.",
              ca: "This cookie stores the user's consent state for the current domain.",
              hu: "This cookie stores the user's consent state for the current domain.",
              sv: "This cookie stores the user's consent state for the current domain.",
              cr: "This cookie stores the user's consent state for the current domain.",
              zh: "This cookie stores the user's consent state for the current domain.",
              uk: "This cookie stores the user's consent state for the current domain.",
              sk: "This cookie stores the user's consent state for the current domain.",
              tr: "This cookie stores the user's consent state for the current domain.",
              lt: "This cookie stores the user's consent state for the current domain.",
              cs: "This cookie stores the user's consent state for the current domain.",
              fi: "This cookie stores the user's consent state for the current domain.",
              no: "This cookie stores the user's consent state for the current domain.",
              "pt-br":
                "This cookie stores the user's consent state for the current domain.",
              sl: "This cookie stores the user's consent state for the current domain.",
              ro: "This cookie stores the user's consent state for the current domain.",
              th: "This cookie stores the user's consent state for the current domain.",
              et: "This cookie stores the user's consent state for the current domain.",
              lv: "This cookie stores the user's consent state for the current domain.",
              el: "This cookie stores the user's consent state for the current domain.",
            },
            type: 1,
            category_id: 279760,
            duration: "1 year",
          ...
          },
          {
            ...
            description: {
              ...
              sv: "Used by sites written in JSP. General purpose platform session cookies that are used to maintain users' state across page requests.",
              ...
              ro: "Used by sites written in JSP. General purpose platform session cookies that are used to maintain users' state across page requests.",
              th: "Used by sites written in JSP. General purpose platform session cookies that are used to maintain users' state across page requests.",
              et: "Used by sites written in JSP. General purpose platform session cookies that are used to maintain users' state across page requests.",
              lv: "Used by sites written in JSP. General purpose platform session cookies that are used to maintain users' state across page requests.",
              el: "Used by sites written in JSP. General purpose platform session cookies that are used to maintain users' state across page requests.",
            },
            type: 1,
            category_id: 279760,
            duration: "past",
          ...
          {
            id: 532606,
            cookie_id: "ls_smartpush",
            description: {
              en: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              de: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              fr: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              it: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              es: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              nl: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              bg: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              da: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              ru: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              ar: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              pl: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              pt: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              ca: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              hu: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              sv: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              cr: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              zh: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              uk: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              sk: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              tr: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              lt: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              cs: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              fi: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              no: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              "pt-br":
                "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              sl: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              ro: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              th: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              et: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              lv: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
              el: "This cookie is set by the provider Litespeed Server. This cookie allows the server to store the settings and to improve performance of the site.",
            },
            type: 1,
            category_id: 279760,
            duration: "2 months",
          ...
          },
          {
            ...
            description: {
              ...
              da: "This cookie is used to check if the cookies are enabled on the users' browser.",
              ru: "This cookie is used to check if the cookies are enabled on the users' browser.",
              ar: "This cookie is used to check if the cookies are enabled on the users' browser.",
              pl: "This cookie is used to check if the cookies are enabled on the users' browser.",
              pt: "This cookie is used to check if the cookies are enabled on the users' browser.",
              ca: "This cookie is used to check if the cookies are enabled on the users' browser.",
              hu: "This cookie is used to check if the cookies are enabled on the users' browser.",
              sv: "This cookie is used to check if the cookies are enabled on the users' browser.",
              cr: "This cookie is used to check if the cookies are enabled on the users' browser.",
              zh: "This cookie is used to check if the cookies are enabled on the users' browser.",
              uk: "This cookie is used to check if the cookies are enabled on the users' browser.",
              sk: "This cookie is used to check if the cookies are enabled on the users' browser.",
              tr: "This cookie is used to check if the cookies are enabled on the users' browser.",
              lt: "This cookie is used to check if the cookies are enabled on the users' browser.",
              cs: "This cookie is used to check if the cookies are enabled on the users' browser.",
              fi: "This cookie is used to check if the cookies are enabled on the users' browser.",
              no: "This cookie is used to check if the cookies are enabled on the users' browser.",
              "pt-br":
                "This cookie is used to check if the cookies are enabled on the users' browser.",
              sl: "This cookie is used to check if the cookies are enabled on the users' browser.",
              ro: "This cookie is used to check if the cookies are enabled on the users' browser.",
              th: "This cookie is used to check if the cookies are enabled on the users' browser.",
              et: "This cookie is used to check if the cookies are enabled on the users' browser.",
              lv: "This cookie is used to check if the cookies are enabled on the users' browser.",
              el: "This cookie is used to check if the cookies are enabled on the users' browser.",
            },
            type: 1,
            category_id: 279760,
            duration: "session",
          ...
          },
          {
            ...
            created_from_scan: 1,
            url_pattern_updated: 0,
            created_at: "2021-06-23 03:32:04",
            updated_at: "2021-06-23 03:32:04",
            data_migrated_at: null,
          },
          {
            id: 545254,
      ...
      },
      {
        ...
        cookies: [
          {
            id: 532616,
            cookie_id: "tve_leads_unique",
            description: {
              en: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              de: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              fr: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              it: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              es: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              nl: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              bg: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              da: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              ru: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              ar: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              pl: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              pt: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              ca: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              hu: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              sv: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              cr: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              zh: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              uk: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              sk: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              tr: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              lt: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              cs: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              fi: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              no: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              "pt-br":
              ...
              sl: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              ro: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              th: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              et: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              lv: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
              el: "This cookie is set by the provider Thrive Themes. This cookie is used to know which optin form the visitor has filled out when subscribing a newsletter.",
            },
            type: 1,
            category_id: 279761,
            duration: "1 month",
            ...
            created_from_scan: 1,
            url_pattern_updated: 0,
            created_at: "2021-06-18 19:08:39",
            updated_at: "2021-06-18 19:08:39",
            data_migrated_at: null,
          },
        ],
        scripts: [],
        ...
        cookies: [
          {
            ...
            description: {
              ...
              et: "This domain of this cookie is owned by Vimeo. This cookie is used by vimeo to collect tracking information. It sets a unique ID to embed videos to the website. ",
              lv: "This domain of this cookie is owned by Vimeo. This cookie is used by vimeo to collect tracking information. It sets a unique ID to embed videos to the website. ",
              el: "This domain of this cookie is owned by Vimeo. This cookie is used by vimeo to collect tracking information. It sets a unique ID to embed videos to the website. ",
            },
            type: 1,
            category_id: 279762,
            duration: "2 years",
          ...
          {
            id: 532615,
            cookie_id: "_gat_gtag_UA_24282214_1",
            description: {
      ...
      },
      {
        ...
        cookies: [
          ...
          },
          {
            ...
            type: 0,
            category_id: 279869,
            duration: "16 years 6 months 13 days 5 hours",
            domain: ".youtube.com",
            website_id: 52465,
            script_slug: null,
            url_pattern: null,
...
window.addEventListener("load", function () {
  ...
  var defaultToGdpr = ckyActiveLaw ? ckyActiveLaw : "gdpr";
