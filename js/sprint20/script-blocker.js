...
function bannerActiveCheck() {
  ...
  if (!isActiveCheckCookiePresent && window.fetch && window.Promise) {
      fetch("https://active.cookieyes.com/api/4c7e540d5bb57c9caf9ed3c6/log", { method: "POST" }).catch(function (err) {
          console.error(err);
      });
...
var cliConfig = {
  options: {
      ...
      colors: {
          gdpr: {
              notice: { bg: "#fff", borderColor: "#d4d8df", textColor: "#565662", titleColor: "#565662" },
              buttons: {
                  accept: { bg: "#0342b5", borderColor: "#0443b5", textColor: "#fff" },
                  settings: { bg: "transparent", borderColor: "transparent", textColor: "#7f7f7f" },
                  reject: { bg: "#dedfe0", borderColor: "transparent", textColor: "#717375" },
                  readMore: { bg: "transparent", borderColor: "transparent", textColor: "#565662" },
              },
              popup: { pills: { bg: "#f2f5fa", textColor: "#000000", activeBg: "#ffffff", activeTextColor: "#000000" }, acceptCustomButton: { bg: "#ffffff", borderColor: "#0342b5", textColor: "#0342b5" } },
          },
      },
      position: "bottom",
      content: {
      ...
      display: { gdpr: { notice: true, title: false, buttons: { accept: true, reject: false, settings: true, readMore: false }, noticeToggler: false } },
      behaviour: { reload: false, acceptOnScroll: false, defaultConsent: false, showLogo: true, showAuditTable: true, selectedLanguage: "en" },
      ...
      categories: [
          {
              ...
              website_id: 8846,
              settings: null,
              created_at: "2021-06-15 12:49:40",
              updated_at: "2021-06-15 12:49:40",
              cookies: [
                  {
                      id: 7583,
                      cookie_id: "_GRECAPTCHA",
                      description: {
                          ...
                          de: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          fr: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          it: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          es: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          nl: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          bg: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          da: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          ru: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          ar: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          pl: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          pt: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          ca: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          hu: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          sv: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          cr: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          zh: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          uk: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          sk: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          tr: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          lt: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          cs: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          fi: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          no: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          "pt-br": "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          sl: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          ro: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                          th: "This cookie is set by Google. In addition to certain standard Google cookies, reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed for the purpose of providing its risk analysis.",
                      },
                      type: 1,
                      category_id: 16652,
                      ...
                      created_at: "2021-06-15 12:50:09",
                      updated_at: "2021-06-15 12:50:09",
                  ...
                  },
                  {
                      ...
                      created_from_scan: 1,
                      url_pattern_updated: 0,
                      created_at: "2021-06-15 12:58:35",
                      updated_at: "2021-06-15 12:58:35",
                      data_migrated_at: null,
                  },
                  {
                      id: 7590,
                  ...
                  },
                  {
                      ...
                      created_from_scan: 1,
                      url_pattern_updated: 0,
                      created_at: "2021-06-15 12:58:52",
                      updated_at: "2021-06-15 12:58:52",
                      data_migrated_at: null,
                  },
              ],
              scripts: [],
          },
          {
              ...
              settings: null,
              created_at: "2021-06-15 12:49:40",
              updated_at: "2021-06-15 12:49:46",
              cookies: [
                  {
                      id: 7606,
                      ...
                      description: {
                          ...
                          "pt-br": "This cookie is set by Tawk.to which is a live chat functionality. The cookie is used to remember users so that previous chats can be linked together to provide better and improved service.",
                  ...
                  },
                  {
                      ...
                      description: {
                          ...
                          "pt-br": "This cookie is set by the provider Eventbrite. This cookie is used for the functionality of website chat-box function.",
          ...
          },
          {
              ...
              cookies: [
                  ...
                  {
                      id: 7587,
                      cookie_id: "_gat_gtag_UA_114405147_3",
                      description: {
                          ...
                          da: "Google uses this cookie to distinguish users.",
                          ru: "Google uses this cookie to distinguish users.",
                          ar: "Google uses this cookie to distinguish users.",
                          pl: "Google uses this cookie to distinguish users.",
                          pt: "Google uses this cookie to distinguish users.",
                          ca: "Google uses this cookie to distinguish users.",
                          hu: "Google uses this cookie to distinguish users.",
                          sv: "Google uses this cookie to distinguish users.",
                          cr: "Google uses this cookie to distinguish users.",
                          zh: "Google uses this cookie to distinguish users.",
                          uk: "Google uses this cookie to distinguish users.",
                          sk: "Google uses this cookie to distinguish users.",
                          tr: "Google uses this cookie to distinguish users.",
                          lt: "Google uses this cookie to distinguish users.",
                          cs: "Google uses this cookie to distinguish users.",
                          fi: "Google uses this cookie to distinguish users.",
                          no: "Google uses this cookie to distinguish users.",
                          "pt-br": "Google uses this cookie to distinguish users.",
                          sl: "Google uses this cookie to distinguish users.",
                          ro: "Google uses this cookie to distinguish users.",
                          th: "Google uses this cookie to distinguish users.",
                      },
                      type: 1,
                      category_id: 16654,
                      duration: "1 minute",
                  ...
                  },
                  {
                      ...
                      description: {
                          ...
                          "pt-br": "This domain of this cookie is owned by Vimeo. This cookie is used by vimeo to collect tracking information. It sets a unique ID to embed videos to the website. ",
              ...
              cookies: [
                  {
                      ...
                      type: 0,
                      category_id: 16657,
                      duration: "16 years 6 months 16 days 11 hours 2 minutes",
                      domain: ".youtube.com",
                      website_id: 8846,
                      script_slug: null,
                      url_pattern: null,
...
const categoryScripts = [
  ...
  { re: "youtube.com", categories: ["performance", "advertisement"] },
