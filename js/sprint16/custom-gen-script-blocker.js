...
var cliConfig = {
    options: {
        ...
        content: {
            gdpr: {
                ...
                title: { de: "Cookie Zustimmung", en: "Cookie consent" },
                buttons: { accept: { de: "Alle akzeptieren", en: "Accept All" }, reject: { de: "Alles ablehnen", en: "Reject All" }, readMore: { de: "Weiterlesen", en: "Read More" }, settings: { de: "Einstellungen", en: "Preferences" } },
                auditTable: { type: { de: "Art", en: "Type" }, cookie: { de: "Cookie", en: "Cookie" }, duration: { de: "Dauer", en: "Duration" }, description: { de: "Beschreibung", en: "Description" } },
                saveButton: { de: "sparen", en: "Save" },
                customLogoUrl: null,
                noticeToggler: { de: "Cookie-Einstellungen", en: "Cookie Settings" },
                placeHolderText: { de: "Bitte akzeptieren Sie die Cookie-Zustimmung", en: "Please accept the cookie consent" },
                privacyPolicyLink: { de: "#", en: "#" },
    ...
    info: {
        categories: [
            {
                ...
                slug: "necessary",
                order: 1,
                name: { en: "Necessary", de: "Notwendige" },
                defaultConsent: 1,
                active: 1,
            ...
            },
            {
                ...
                slug: "functional",
                order: 2,
                name: { en: "Functional", de: "Funktionale" },
                defaultConsent: 0,
                active: 1,
                settings: { ccpa: { doNotSell: false } },
                type: 2,
            ...
            },
            {
                ...
                slug: "performance",
                order: 4,
                name: { en: "Performance", de: "Leistungs" },
                defaultConsent: 0,
                active: 1,
                settings: { ccpa: { doNotSell: false } },
                type: 2,
            ...
            },
            {
                ...
                slug: "advertisement",
                order: 5,
                name: { en: "Advertisement", de: "Werbe" },
                defaultConsent: 0,
                active: 1,
                settings: { ccpa: { doNotSell: false } },
                type: 2,
            ...
            },
            {
                ...
                slug: "other",
                order: 6,
                name: { en: "Other", de: "Andere" },
                defaultConsent: 0,
                active: 1,
                settings: { ccpa: { doNotSell: false } },
                type: 2,
                description: { en: "No description", de: "No description" },
                cookies: [
                    {
                        id: 60803,
        ...
        privacyPolicy: {
            title: { en: "Privacy Policy", de: "Datenschutz-Bestimmungen" },
            text: {
                en:
...
var categoryScripts = [{"name":"necessary","list":["/youtube-nocookie.com/"]},{"name":"functional","list":["/googletagmanager.com/"]}] ;
