...
function bannerActiveCheck() {
  ...
  if (!isActiveCheckCookiePresent && window.fetch && window.Promise) {
    fetch("https://active.cookieyes.com/api/283620d36e7db014be743e51/log", {
      method: "POST",
    }).catch(function (err) {
      console.error(err);
    });
    ...
    categories: [
      {
        ...
        updated_at: "2021-06-14 05:53:06",
        cookies: [
          {
            id: 51941,
      ...
      },
      {
        ...
        settings: { ccpa: { doNotSell: false } },
        created_at: "2020-05-05 08:38:52",
        updated_at: "2021-06-18 05:28:26",
        cookies: [
          {
            id: 80739,
            cookie_id: "1",
...
const categoryScripts = [
  ...
  {
    re: "plugins/activecampaign-subscription-forms",
