...
function ckyCount(callback) {
  ...
  ckyLogCookies = function () {
      ...
      data.append("key", "fbfaf1925e7dd1e9b4dc1fd2");
...
function bannerActiveCheck() {
  ...
  if (!isActiveCheckCookiePresent && window.fetch && window.Promise) {
      fetch("https://active.cookieyes.com/api/fbfaf1925e7dd1e9b4dc1fd2/log", { method: "POST" }).catch(function (err) {
          console.error(err);
      });
...
var tldomain = "www.carone.com.br";
var cliConfig = {
  options: {
      plan: "Basic",
      theme: "light",
      ...
      content: {
          gdpr: {
              ...
              customLogoUrl: "https://www.carone.com.br/skin/frontend/mbootstrap/carone/images/logo.png",
              noticeToggler: {
                  ar: "\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u062e\u0635\u0648\u0635\u064a\u0629",
              ...
              privacyPolicyLink: {
                  ...
                  uk: "#",
                  zh: "#",
                  "pt-br": "https://www.carone.com.br/politica-do-site#cookies",
              },
              customAcceptButton: {
      ...
      tldomain: "www.carone.com.br",
      behaviour: { reload: false, showLogo: true, acceptOnScroll: false, defaultConsent: false, showAuditTable: false, selectedLanguage: "pt-br" },
      customCss: null,
      ...
      categories: [
              ...
              scripts: [
                  {
                      ...
                      description: {
                          ...
                          sv: "These cookies help to perform the critical functions of the website.",
              ...
              cookies: [
                  {
                      ...
                      description: {
                          ...
                          no: "No description",
                          "pt-br":
                              "O cookie \u00e9 usado por servi\u00e7os cdn como CloudFlare para identificar clientes individuais por tr\u00e1s de um endere\u00e7o IP compartilhado e aplicar configura\u00e7\u00f5es de seguran\u00e7a por cliente. N\u00e3o corresponde a nenhum ID de usu\u00e1rio no aplicativo da web e n\u00e3o armazena nenhuma informa\u00e7\u00e3o de identifica\u00e7\u00e3o pessoal.",
                          sl: "No description",
                      },
                      duration: "sess\u00e3o",
                      type: "https",
                      domain: "www.carone.com.br",
                  },
                  {
                      id: 399611,
                      cookie_id: "cf_chl_prog",
                      description: {
                          en: "No description",
                          de: "No description",
                          fr: "No description",
                  ...
                  {
                      id: 399676,
                      cookie_id: "frontend_cid",
                      description: {
                          en: "Cookie utilizado para fornecer a funcionalidade de login no site.",
                          de: "Cookie de Login do Site",
                          fr: "Cookie de Login do Site",
                          it: "Cookie de Login do Site",
                          es: "Cookie de Login do Site",
                          nl: "Cookie de Login do Site",
                          bg: "Cookie de Login do Site",
                          da: "Cookie de Login do Site",
                          ru: "Cookie de Login do Site",
                          ar: "Cookie de Login do Site",
                          pl: "Cookie de Login do Site",
                          pt: "Cookie de Login do Site",
                          ca: "Cookie de Login do Site",
                          hu: "Cookie de Login do Site",
                          sv: "Cookie de Login do Site",
                          cr: "Cookie de Login do Site",
                          zh: "Cookie de Login do Site",
                          uk: "Cookie de Login do Site",
                          sk: "Cookie de Login do Site",
                          tr: "Cookie de Login do Site",
                          lt: "Cookie de Login do Site",
                          cs: "Cookie de Login do Site",
                          fi: "Cookie de Login do Site",
                          no: "Cookie de Login do Site",
                          "pt-br": "Cookie utilizado para habilitar a funcionalidade de login do site.",
                          sl: "Cookie de Login do Site",
                      },
                      duration: "5 dias",
                      type: "https",
                      domain: ".carone.com.br",
                  },
                  {
                      ...
                      cookie_id: "frontend",
                      description: {
                          en: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          de: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          fr: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          it: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          es: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          nl: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          bg: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          da: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          ru: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          ar: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          pl: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          pt: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          ca: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          hu: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          sv: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          cr: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          zh: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          uk: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          sk: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          tr: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          lt: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          cs: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          fi: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          no: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          "pt-br": "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                          sl: "Cookie de obrigat\u00f3rio para funcionamento da loja virtual.",
                      },
                      duration: "5 dias",
                      type: "https",
                      domain: ".carone.com.br",
                  ...
                  {
                      id: 417350,
                      cookie_id: "postcode-once",
                      description: {
                          en: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          de: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          fr: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          it: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          es: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          nl: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          bg: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          da: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          ru: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          ar: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          pl: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          pt: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          ca: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          hu: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          sv: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          cr: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          zh: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          uk: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          sk: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          tr: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          lt: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          cs: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          fi: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          no: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          "pt-br": "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                          sl: "Cookie necess\u00e1rio para salvar op\u00e7\u00e3o de CEP informada pelo cliente.",
                      },
                      duration: "3 horas",
                      type: "https",
                      domain: ".carone.com.br",
          ...
          },
          {
              ...
              cookies: [
                  {
                      id: 399718,
                      cookie_id: "hgyclh-w15774",
                      description: {
                          en: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          de: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          fr: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          it: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          es: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          nl: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          bg: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          da: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          ru: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          ar: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          pl: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          pt: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          ca: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          hu: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          sv: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          cr: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          zh: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          uk: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          sk: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          tr: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          lt: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          cs: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          fi: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          no: "Cookie utilizado para a ferramenta de Web Chat do site.",
                          "pt-br": "Cookie utilizado para a ferramenta de Web Chat do site.",
                          sl: "Cookie utilizado para a ferramenta de Web Chat do site.",
                      },
                      duration: "1 ano",
                      type: "https",
                      domain: ".carone.com.br",
              ...
              cookies: [
                  {
                      ...
                      cookie_id: "_gid",
                      description: {
                          en: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          de: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          fr: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          it: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          es: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          nl: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          bg: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          da: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          ru: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          ar: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          pl: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          pt: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          ca: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          hu: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          sv: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          cr: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          zh: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          uk: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          sk: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          tr: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          lt: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          cs: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          fi: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          no: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                          "pt-br": "Cookie de Ferramentas do Google utilizado para para distinguir usu\u00e1rios.",
                          sl: "Cookie do Google Analytics para implementa\u00e7\u00e3o de melhorias e performance no site.",
                      },
                      duration: "24 horas",
                      type: "https",
                      domain: ".carone.com.br",
                  },
                  {
                      ...
                      cookie_id: "_ga",
                      description: {
                          en: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          de: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          fr: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          it: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          es: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          nl: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          bg: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          da: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          ru: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          ar: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          pl: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          pt: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          ca: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          hu: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          sv: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          cr: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          zh: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          uk: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          sk: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          tr: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          lt: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          cs: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          fi: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          no: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                          "pt-br": "Cookie de Ferramentas do Google utilizado para para distinguir usu\u00e1rios.",
                          sl: "Cookie da Ferramenta Google Analytics utilizada para analisada para funcionalidade e performance.",
                      },
                      duration: "2 anos",
                      type: "https",
                      domain: ".carone.com.br",
              ...
              cookies: [
                  {
                      ...
                      cookie_id: "rdtkr",
                      description: {
                          en: "Cookie da ferramenta de campanhas de Marketing.",
                          de: "Cookie da ferramenta de campanhas de Marketing.",
                          fr: "Cookie da ferramenta de campanhas de Marketing.",
                          it: "Cookie da ferramenta de campanhas de Marketing.",
                          es: "Cookie da ferramenta de campanhas de Marketing.",
                          nl: "Cookie da ferramenta de campanhas de Marketing.",
                          bg: "Cookie da ferramenta de campanhas de Marketing.",
                          da: "Cookie da ferramenta de campanhas de Marketing.",
                          ru: "Cookie da ferramenta de campanhas de Marketing.",
                          ar: "Cookie da ferramenta de campanhas de Marketing.",
                          pl: "Cookie da ferramenta de campanhas de Marketing.",
                          pt: "Cookie da ferramenta de campanhas de Marketing.",
                          ca: "Cookie da ferramenta de campanhas de Marketing.",
                          hu: "Cookie da ferramenta de campanhas de Marketing.",
                          sv: "Cookie da ferramenta de campanhas de Marketing.",
                          cr: "Cookie da ferramenta de campanhas de Marketing.",
                          zh: "Cookie da ferramenta de campanhas de Marketing.",
                          uk: "Cookie da ferramenta de campanhas de Marketing.",
                          sk: "Cookie da ferramenta de campanhas de Marketing.",
                          tr: "Cookie da ferramenta de campanhas de Marketing.",
                          lt: "Cookie da ferramenta de campanhas de Marketing.",
                          cs: "Cookie da ferramenta de campanhas de Marketing.",
                          fi: "Cookie da ferramenta de campanhas de Marketing.",
                          no: "Cookie da ferramenta de campanhas de Marketing.",
                          "pt-br": "Usado para guardar a lista de todas as p\u00e1ginas que um visitante acessou dentro do site mesmo antes da convers\u00e3o.",
                          sl: "Cookie da ferramenta de campanhas de Marketing.",
                      },
                      duration: "1 ano",
                      type: "https",
                      domain: ".carone.com.br",
                  },
                  {
                      ...
                      cookie_id: "__trf.src",
                      description: {
                          en: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          de: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          fr: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          it: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          es: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          nl: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          bg: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          da: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          ru: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          ar: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          pl: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          pt: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          ca: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          hu: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          sv: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          cr: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          zh: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          uk: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          sk: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          tr: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          lt: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          cs: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          fi: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          no: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          "pt-br": "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                          sl: "Usado para guardar a refer\u00eancia de origem de uma visita de um usu\u00e1rio ao site",
                      },
                      duration: "2 anos",
                      type: "https",
                      domain: ".carone.com.br",
              ...
              cookies: [
                  {
                      ...
                      cookie_id: "_kdt",
                      description: {
                          en: "Cookie utilizado por ferramentas de marketing.",
                          de: "Cookie utilizado por ferramentas de marketing.",
                          fr: "Cookie utilizado por ferramentas de marketing.",
                          it: "Cookie utilizado por ferramentas de marketing.",
                          es: "Cookie utilizado por ferramentas de marketing.",
                          nl: "Cookie utilizado por ferramentas de marketing.",
                          bg: "Cookie utilizado por ferramentas de marketing.",
                          da: "Cookie utilizado por ferramentas de marketing.",
                          ru: "Cookie utilizado por ferramentas de marketing.",
                          ar: "Cookie utilizado por ferramentas de marketing.",
                          pl: "Cookie utilizado por ferramentas de marketing.",
                          pt: "Cookie utilizado por ferramentas de marketing.",
                          ca: "Cookie utilizado por ferramentas de marketing.",
                          hu: "Cookie utilizado por ferramentas de marketing.",
                          sv: "Cookie utilizado por ferramentas de marketing.",
                          cr: "Cookie utilizado por ferramentas de marketing.",
                          zh: "Cookie utilizado por ferramentas de marketing.",
                          uk: "Cookie utilizado por ferramentas de marketing.",
                          sk: "Cookie utilizado por ferramentas de marketing.",
                          tr: "Cookie utilizado por ferramentas de marketing.",
                          lt: "Cookie utilizado por ferramentas de marketing.",
                          cs: "Cookie utilizado por ferramentas de marketing.",
                          fi: "Cookie utilizado por ferramentas de marketing.",
                          no: "Cookie utilizado por ferramentas de marketing.",
                          "pt-br": "Cookie utilizado por ferramentas de marketing.",
                          sl: "Cookie utilizado por ferramentas de marketing.",
                      },
                      duration: "1 ano",
                      type: "https",
                      domain: ".carone.com.br",
                  },
                  {
                      ...
                      cookie_id: "__kdtv",
                      description: {
                          en: "Cookies utilizados para as campanhas de marketing.",
                          de: "Cookies utilizados para as campanhas de marketing.",
                          fr: "Cookies utilizados para as campanhas de marketing.",
                          it: "Cookies utilizados para as campanhas de marketing.",
                          es: "Cookies utilizados para as campanhas de marketing.",
                          nl: "Cookies utilizados para as campanhas de marketing.",
                          bg: "Cookies utilizados para as campanhas de marketing.",
                          da: "Cookies utilizados para as campanhas de marketing.",
                          ru: "Cookies utilizados para as campanhas de marketing.",
                          ar: "Cookies utilizados para as campanhas de marketing.",
                          pl: "Cookies utilizados para as campanhas de marketing.",
                          pt: "Cookies utilizados para as campanhas de marketing.",
                          ca: "Cookies utilizados para as campanhas de marketing.",
                          hu: "Cookies utilizados para as campanhas de marketing.",
                          sv: "Cookies utilizados para as campanhas de marketing.",
                          cr: "Cookies utilizados para as campanhas de marketing.",
                          zh: "Cookies utilizados para as campanhas de marketing.",
                          uk: "Cookies utilizados para as campanhas de marketing.",
                          sk: "Cookies utilizados para as campanhas de marketing.",
                          tr: "Cookies utilizados para as campanhas de marketing.",
                          lt: "Cookies utilizados para as campanhas de marketing.",
                          cs: "Cookies utilizados para as campanhas de marketing.",
                          fi: "Cookies utilizados para as campanhas de marketing.",
                          no: "Cookies utilizados para as campanhas de marketing.",
                          "pt-br": "Cookies utilizados para as campanhas de marketing.",
                          sl: "Cookies utilizados para as campanhas de marketing.",
                      },
                      duration: "3 horas",
                      type: "https",
                      domain: ".carone.com.br",
                  },
                  {
                      ...
                      cookie_id: "_fbp",
                      description: {
                          en: "Cookie do Facebook para campanhas de marketing.",
                          de: "Cookie do Facebook para campanhas de marketing.",
                          fr: "Cookie do Facebook para campanhas de marketing.",
                          it: "Cookie do Facebook para campanhas de marketing.",
                          es: "Cookie do Facebook para campanhas de marketing.",
                          nl: "Cookie do Facebook para campanhas de marketing.",
                          bg: "Cookie do Facebook para campanhas de marketing.",
                          da: "Cookie do Facebook para campanhas de marketing.",
                          ru: "Cookie do Facebook para campanhas de marketing.",
                          ar: "Cookie do Facebook para campanhas de marketing.",
                          pl: "Cookie do Facebook para campanhas de marketing.",
                          pt: "Cookie do Facebook para campanhas de marketing.",
                          ca: "Cookie do Facebook para campanhas de marketing.",
                          hu: "Cookie do Facebook para campanhas de marketing.",
                          sv: "Cookie do Facebook para campanhas de marketing.",
                          cr: "Cookie do Facebook para campanhas de marketing.",
                          zh: "Cookie do Facebook para campanhas de marketing.",
                          uk: "Cookie do Facebook para campanhas de marketing.",
                          sk: "Cookie do Facebook para campanhas de marketing.",
                          tr: "Cookie do Facebook para campanhas de marketing.",
                          lt: "Cookie do Facebook para campanhas de marketing.",
                          cs: "Cookie do Facebook para campanhas de marketing.",
                          fi: "Cookie do Facebook para campanhas de marketing.",
                          no: "Cookie do Facebook para campanhas de marketing.",
                          "pt-br": "Cookie do Facebook para campanhas de marketing.",
                          sl: "Cookie do Facebook para campanhas de marketing.",
                      },
                      duration: "3 meses",
                      type: "https",
                      domain: ".carone.com.br",
                  },
                  {
                      ...
                      cookie_id: "_gcl_au",
                      description: {
                          en: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          de: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          fr: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          it: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          es: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          nl: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          bg: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          da: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          ru: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          ar: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          pl: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          pt: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          ca: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          hu: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          sv: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          cr: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          zh: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          uk: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          sk: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          tr: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          lt: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          cs: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          fi: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          no: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          "pt-br": "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                          sl: "Cookie utilizado pela ferramenta de Marketing Google Adsense",
                      },
                      duration: "3 meses",
                      type: "https",
                      domain: ".carone.com.br",
